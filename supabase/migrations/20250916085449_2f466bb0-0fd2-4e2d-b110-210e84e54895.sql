...
CREATE INDEX IF NOT EXISTS idx_upsell_products_shop_domain ON public.upsell_products(shop_domain);
CREATE INDEX IF NOT EXISTS idx_upsell_products_active ON public.upsell_products(shop_domain, is_active);
CREATE INDEX IF NOT EXISTS idx_cart_analytics_shop_event ON public.cart_analytics(shop_domain, event_type);